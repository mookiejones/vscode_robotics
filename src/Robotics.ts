...
import { TreeDataProvider, Event, EventEmitter, TreeItem, TreeItemCollapsibleState } from 'vscode';
		...
		if (this.pathExists(packageJsonPath)) {
			...
			const toDep = (moduleName: string): Dependency => {
				if (this.pathExists(path.join(this.workspaceRoot, 'node_modules', moduleName))) {
					return new Dependency(moduleName, TreeItemCollapsibleState.Collapsed);
				} else {
					return new Dependency(moduleName, TreeItemCollapsibleState.None, {
